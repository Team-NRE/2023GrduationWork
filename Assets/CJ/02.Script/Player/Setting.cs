...
public partial class PlayerManager 
{
    ...
    public void KeyMapping()
    {
        ...
        {
            if (ButtonPushTime < 0.3) { gameManager.instance.UI.UseCard(0); } //탭하면 SKill 사용
        ...
        {
            if (ButtonPushTime < 0.3) { gameManager.instance.UI.UseCard(1); } //탭하면 SKill 사용
            ButtonPushTime = 0; //초기화
        }
        #endregion
        ...
        {
            if (ButtonPushTime < 0.3) { gameManager.instance.UI.UseCard(2); } //탭하면 SKill 사용
        ...
        {
            if (ButtonPushTime < 0.3) { gameManager.instance.UI.UseCard(3); } //탭하면 SKill 사용
            ButtonPushTime = 0; //초기화
        }
